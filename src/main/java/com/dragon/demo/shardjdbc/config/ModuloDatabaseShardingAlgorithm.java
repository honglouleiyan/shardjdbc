package com.dragon.demo.shardjdbc.config;
...
/**
* @author heaven.long
* @version 创建时间：2018年9月7日 上午11:57:39
* 类说明
*/
public class ModuloDatabaseShardingAlgorithm implements SingleKeyDatabaseShardingAlgorithm<Long> {

	
	//参数dataSourceNames的值为[test_msg_0 , test_msg_1]，而shardingValue在执行的时候可以获取到 user_id=10这个值
	@Override
